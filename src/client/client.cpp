...
void         Client::Handle(Request &req, const std::vector<LocationConfig>& locations, const ServerConfig &server, Client *client, Epoll &epoll)
{
    ...
    std::cout << "getHadRedirect: " << loc->getHasRedirect() << std::endl;
    ...
    std::cout << "lets get static file" << std::endl;
    StaticTarget st;
...
"<div class=\"container\">\n"
"  <h1>🌸 Page moved</h1>\n"
"  <p>This page has moved to a new location: " <<redir << ".</p>\n"
"  <footer>Served softly by your webserv 💕</footer>\n"
"</div>\n"
"</body>\n"
"</html>\n";
    Response res;
